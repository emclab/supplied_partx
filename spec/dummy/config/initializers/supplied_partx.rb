...
SuppliedPartx.index_payment_request_path = "payment_requestx.payment_requests_path(:resource_id => r.id, :resource_string => params[:controller])"
SuppliedPartx.index_payment_request_supplied_partx_path = "payment_requestx.payment_requests_path(:resource_id => r.id, :resource_string => params[:controller], :subaction => 'supplied_partx')"
