module SuppliedPartx
  ...
  class Part < ActiveRecord::Base
    ...
    attr_accessible :actual_receiving_date, :purchasing_id, :requested_by_id, :last_updated_by_id, :name, :order_date, :part_num, :project_id, :qty, :received, :manufacturer_id,
                    ...
                    :total, :brief_note, :purchase_order_id, :approved, :approved_date, :approved_by_id, :delivered, :delivery_date, :delivery_received_by_id, :brand,
    ...
    attr_accessible :actual_receiving_date, :purchasing_id, :requested_by_id, :last_updated_by_id, :name, :order_date, :part_num, :project_id, :qty, :received, :manufacturer_id,
                    ...
                    :purchase_order_id, :purchase_order_id_noupdate, :approved, :approved_date, :wf_state_noupdate,  :approved_by_id, :delivered, :delivery_date, :delivery_received_by_id, :brand,
                    :as => :role_update
