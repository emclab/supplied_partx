module SuppliedPartx
  ...
  class Part < ActiveRecord::Base
    ...
    attr_accessible :actual_receiving_date, :purchasing_id, :requested_by_id, :last_updated_by_id, :name, :order_date, :part_num, :project_id, :qty, :received, :manufacturer_id,
                    ...
                    :total, :brief_note, :purchase_order_id, :approved, :approved_date, :approved_by_id, :delivered, :delivery_received_by_id, :delivery_date,
    ...
    attr_accessible :actual_receiving_date, :purchasing_id, :requested_by_id, :last_updated_by_id, :name, :order_date, :part_num, :project_id, :qty, :received, :manufacturer_id,
                    ...
                    :purchase_order_id, :purchase_order_id_noupdate, :approved, :approved_date, :approved_by_id, :delivered, :delivery_received_by_id, :delivery_date, :wf_state_noupdate,
                    :as => :role_update
    ...
    attr_accessor   :project_id_s, :start_date_s, :end_date_s, :purchasing_id_s, :customer_id_s, :eng_id_s, :name_s, :part_spec_s, :part_num_s, :purchase_order_id_s,
                    :supplier_id_s, :delivered_s, :time_frame_s, :keyword_s, :status_id_s, :requested_by_id_s, :manufacturer_id_s, :approved_s, :delivered_s

    attr_accessible :project_id_s, :start_date_s, :end_date_s, :purchasing_id_s, :customer_id_s, :eng_id_s, :status_id_s, :manufacturer_id_s, :approved_s, :delivered_s,
    ...
    belongs_to :delivery_received_by, :class_name => 'Authentify::User'
